class Cast:
    """A collection of actors. The responsibility of Cast is to keep track of a collection of actors.
    It had methods for adding, removing and getting them by a group name.
    
    Attributes:
        _actors (dict): a dict of actors {key: group_name, value: a list of actors}
    """
