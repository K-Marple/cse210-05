...
class Video:
    """Outputs the game state. The responsibility of Video is to draw the game state
    on the screen.
    """

    def __init__(self, debug=False):
        """Constructs a new Video using the specified debug mode.
    ...
    def close_window(self):
        """Closes the window and releases all computing resourses."""
        pyray.close_window()
